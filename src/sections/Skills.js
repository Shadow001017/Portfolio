          ...
          <LoadAnimate amount={0}>
            <div className="z-20 mx-auto w-full text-center lg:w-3/4 xl:w-1/2">
              ...
              <p className="text-base leading-relaxed sm:text-lg">
                He possess extensive experience, leadership skills, system design expertise, advanced problem-solving
                abilities, effective collaboration and communication skills, a commitment to continuous learning, and a
                focus on quality assurance. These qualities make him an excellent fit for leading complex projects,
